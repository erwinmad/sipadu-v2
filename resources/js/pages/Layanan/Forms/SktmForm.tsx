...
export default function SktmForm({ slug, kecamatans, onSuccess }: SktmFormProps) {
    ...
    return (
        <form onSubmit={submit} className="space-y-8">
            ...
            <div className="border-t border-gray-100 pt-6">
               ...
               <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                     <FileUpload
                        label="Scan KTP Kepala Keluarga"
                        id="ktp"
                        file={data.ktp}
                    ...
                    />
                     <FileUpload
                        ...
                        id="pernyataan"
                        file={data.pernyataan}
                        onChange={(f) => setData('pernyataan', f)}
                        error={errors.pernyataan}
                        required
                    />
                </div>
            </div>
