                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
                            ...
                            <div className="flex gap-12">
                                <div>
                                    <h4 className="font-bold text-slate-900 dark:text-slate-100 mb-3 text-xs uppercase tracking-wider">Layanan</h4>
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-900 dark:text-slate-100 mb-3 text-xs uppercase tracking-wider">Bantuan</h4>
                                    <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
